...
questionsList = [("2+2", "4"), ("5-2", "3"), ("9-7", "2"), ("8+1", "9"),
                 ...
                 ("6+4-5", "5"), ("2+6-7+1","2"), ("(5*2)-3","7"), ("((5*10)/2)-19", "6")
                 ("log(8)*((9/3)/3)","3")]
...
def read_name(conn):
    try:
        ...
        print("{}{} has joined the game{}".format(bcolors.OKGREEN,clientName,bcolors.ENDC))
    except Exception as e:
...
def handle_client(conn, clientIndex, question, answer):
    ...
    try:
        ...
        print("{}From handle_client {}{}".format(bcolors.FAIL,e,bcolors.ENDC))
        conn.close()
...
def accept_clients(serverSocket):
    try:
        ...
        print("{}From accept_clients {}{}".format(bcolors.FAIL,e,bcolors.ENDC))
...
def start_server():
    try:
        ...
        print("{}Server started, listening on IP address {}{}".format(bcolors.OKCYAN,SERVER_IP,bcolors.ENDC))
        return serverSocket
    except Exception as e:
...
def sendGameSummary():
    try:
        ...
        print("{}From sendGameSummary {}{}".format(bcolors.FAIL,e,bcolors.ENDC))
...
"""
def printGameOver():
    print("{}Game over, sending out offer requests...{}".format(bcolors.OKBLUE,bcolors.ENDC))
...
def closeConnections():
    try:
        ...
        print("{}From closeConnections {}{}".format(bcolors.FAIL,e,bcolors.ENDC))
...
"""
def setGlobals():
    global def_tstp_handler,SERVER_PORT, udpMsg
